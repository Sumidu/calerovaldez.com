...
We have found in literature that the *setosa* species has a rather small petal length of only about 3-4 cm. Since your sampling from random flowers you want to test whether your sample is also smaller than, let us say, 5cm. Thus, our null hypothesis would be $H_0: PL > 5$.
